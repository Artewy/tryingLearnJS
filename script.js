...
// Большие сложные события -- scope (Зум), swipe, drag'n'drop (удерживай и бросай (перетаскивание))

// Дополнительные свойства объекта у события (у event)
// 3 Главных свойства при работе с мобилками
// 1 -- touches (список пальцев, которые сейчас взаимодействуют с экраном)
// 2 -- targetTouches (все пальцы взаимодействуют с объектом)
// 3 -- changedTouches (список пальцев, участвующих в текущем событии (touchend -- палец был убран, даже если остальные остались на экране))
